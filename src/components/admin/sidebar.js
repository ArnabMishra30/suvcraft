...
const NAV = [
  ...
  },
  {
    ...
    children: [
      { href: '/admin/blogs', label: 'Blog Categories' },
      { href: '/admin/blogs/posts', label: 'Manage Blogs' },
    ],
  },
  {
    label: 'Support Desk',
    ...
    children: [
      ...
      { href: '/admin/support/ticket-types', label: 'Ticket Types' },
      { href: '/admin/support/tickets', label: 'Ticket System' },
    ],
  },
  {
    label: 'Notifications',
    ...
    children: [
      ...
      { href: '/admin/notifications/custom-message', label: 'Custom Message' },
    ],
  },
  {
    ...
    children: [
      ...
      { href: '/admin/settings/system-health', label: 'System Health' },
      { href: '/admin/settings/email', label: 'Email Settings' },
      { href: '/admin/settings/payment-methods', label: 'Payment Methods' },
      { href: '/admin/settings/shipping', label: 'Shipping Methods' },
      { href: '/admin/settings/time-slots', label: 'Time Slots' },
  ...
  { href: '/admin/promo-codes', label: 'Promo Codes', icon: 'M7 7h.01M7 3h5a1.99 1.99 0 011.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.99 1.99 0 013 12V7a4 4 0 014-4z' },
  {
    label: 'Featured Sections',
    icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z',
    children: [
      { href: '/admin/featured-sections', label: 'Manage Sections' },
      { href: '/admin/featured-sections/order', label: 'Sections Order' },
    ],
  },
  {
    label: 'Reports',
    ...
    children: [
      ...
      { href: '/admin/reports/inventory', label: 'Sale Inventory Reports' },
    ],
  },
  {
